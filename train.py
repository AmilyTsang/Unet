...
def parse_args():
    ...
    # dataset
    parser.add_argument('--dataset', default='dianjiao_dataset',
                        help='dataset name')
...
def main():
    ...
    train_img_ids, val_img_ids = train_test_split(img_ids, test_size=0.9, random_state=41)  # 将样本分为测试集和训练集，测试集占比0.9
    #数据增强：
